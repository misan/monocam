...
// and returns the correct z-value for the tool
// if no contact point is found the function returns null
// 
// There are three tests:
// 1. cutter vs. vertex
//    described at http://www.anderswallin.net/2007/06/drop-cutter-part-13-cutter-vs-vertex/
// 2. cutter vs. facet
//    described at http://www.anderswallin.net/2007/06/drop-cutter-part-23-cutter-vs-facet/
// 3. cutter vs. edge
//    http://www.anderswallin.net/2007/07/drop-cutter-33-edge-test/
//
// The facet test uses a function isinside(Tri,Point) which returns true 
// if the projection of the point onto the xy planes lies within the projection
// of the triangle onto the xy plane.
// it is described at http://www.anderswallin.net/2007/06/point-in-triangle-test/
//
...
namespace monoCAM
{
    class Cutter
    {
        ...
        //
        // when r=0 the cutter is cylindrical
        // when r=R the cutter is spherical (ball-nose)
        // when 0<r<R the cutter is toroidal (bull-nose, fillet endmill)
